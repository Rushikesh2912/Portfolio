...
const Navbar = () => {
    ...
    return (
        <div className={`navbar-container`}>
            <nav className="navbar navbar-expand-lg navbar-dark">
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul style={{fontSize: '1rem'}} className="navbar-nav">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 50 1440 350">
                <path fill="#273038" fillOpacity="1" d="M0,320L60,282.7C120,245,240,171,360,149.3C480,128,600,160,720,181.3C840,203,960,213,1080,197.3C1200,181,1320,139,1380,117.3L1440,96L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z" />
            </svg>
        </div>
    );
}
