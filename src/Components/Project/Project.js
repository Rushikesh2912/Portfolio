...
const Project = () => {
  ...
  return (
    <div className='container text-start'>
      <div className="row">
        <div className={`col-sm-4 my-5 ${isVisible ? 'fade-in' : ''}`}>
      ...
      <div className="row ">
        ...
        <div className="col-md-6 my-4">
          ...
          <a href="https://github.com/Rushikesh2912/Digital-Note-Book" target="_blank" rel="noopener noreferrer">
      ...
      <div className="row">
        <div className="col-md-6 my-4">
          ...
          <span className='m-3'><b>Github Repositry :</b></span>
          <a href="https://github.com/Rushikesh2912/NewsReport" target="_blank" rel="noopener noreferrer">
            <i style={{ fontSize: '30px', cursor: 'pointer', color: 'black' }} className="fa-brands fa-github"></i>
          </a>
      ...
      <div className="row">
        <div className="col-md-6 my-4">
          ...
          <span className='m-3'><b>Github Repositry :</b></span>
          <a href="https://github.com/Rushikesh2912/Travel-Management-System" target="_blank" rel="noopener noreferrer">
            <i style={{ fontSize: '30px', cursor: 'pointer', color: 'black' }} className="fa-brands fa-github"></i>
          </a>
